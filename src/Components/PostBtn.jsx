...
function PostBtn() {
  ...
  return (
    <button
      ...
      className="focus:ring-orangeColorHover border-orangeColor ring-orangeColor  hover:text-btnHover group absolute bottom-7 right-7 flex items-center justify-center rounded-full border bg-secondaryColor p-2 text-center text-black  opacity-85 ring ring-offset-2 transition-all duration-500 hover:border-black hover:ring-offset-4 focus:scale-[0.9] focus:ring-2 focus:ring-offset-2 md:bottom-12 md:right-12 md:p-2"
    >
